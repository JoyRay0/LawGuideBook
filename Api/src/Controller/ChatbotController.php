...
class ChatbotController{
    ...
    private function check_text(string $text) : string{
        ...
        $words = [
            ...
            "that" => "যে", "যে" => "যে", "যেই" => "যে", "যেথা" => "যে", "je" => "যে", "ja" => "যে",

            "he" => "সে", "she" => "সে", "সে" => "সে", "সেথা" => "সে", "sa" => "সে", "se" => "সে",
            "sha" => "সে",

            "yes" => "হ্যাঁ", "yea" => "হ্যাঁ", "ya" => "হ্যাঁ", "yap" => "হ্যাঁ", "hmm" => "হ্যাঁ", "hm" => "হ্যাঁ",
            "yapp" => "হ্যাঁ", "yeah" => "হ্যাঁ", "yas" => "হ্যাঁ", "হ্যাঁ" => "হ্যাঁ", "ha" => "হ্যাঁ", "ho" => "হ্যাঁ",
            "hoa" => "হ্যাঁ", "hea" => "হ্যাঁ", "haa" => "হ্যাঁ",

            "যাদের" => "যাদের", "jader" => "যাদের", "jaader" => "যাদের", "jdr" => "যাদের", "jhader" => "যাদের",

            "we" => "আমরা", "আমরা" => "আমরা", "amra" => "আমরা", "ahmra" => "আমরা", "মোরা" => "আমরা",
            "আরা" => "আমরা", "ara" => "আমরা", "mora" => "আমরা", "mhora" => "আমরা",

            "rab" => "র‍্যাব", "rav" => "র‍্যাব", "র‍্যাব" => "র‍্যাব", "র‍েব" => "র‍্যাব", "র‍েফ" => "র‍্যাব", "reb" => "র‍্যাব",

            "transport" => "পরিবহন", "transit" => "পরিবহন", "transportation" => "পরিবহন", "পরিবহন" => "পরিবহন",
            "poribahon" => "পরিবহন", "paribhon" => "পরিবহন", "poribhan" => "পরিবহন", "transportations" => "পরিবহন",
            "transporting" => "পরিবহন", "transports" => "পরিবহন", "transportment" => "পরিবহন", "transportance" => "পরিবহন",

            "car" => "গাড়ি", "gare" => "গাড়ি", "vehicle" => "গাড়ি", "van" => "গাড়ি", "গাড়ি" => "গাড়ি",
            "gari" => "গাড়ি", "ghari" => "গাড়ি", "gri" => "গাড়ি", "বাস" => "গাড়ি", "প্রাইভেট কার" => "গাড়ি", "ট্রাক" => "গাড়ি",
            "track" => "গাড়ি", "minitrack" => "গাড়ি", "mini track" => "গাড়ি", "bus" => "গাড়ি", "buss" => "গাড়ি",
            "vehicles" => "গাড়ি", "lagona" => "গাড়ি", "legona" => "গাড়ি", "লেগুনা" => "গাড়ি", "noha" => "গাড়ি",
            "noa" => "গাড়ি", "mini van" => "গাড়ি", "mini ban" => "গাড়ি", "hiachs" => "গাড়ি", "hich" => "গাড়ি",
            "hiacks" => "গাড়ি", "big bus" => "গাড়ি", "mini bus" => "গাড়ি", "choto bus" => "গাড়ি", "choto gari" => "গাড়ি",
            "ev" => "গাড়ি", "personal car" => "গাড়ি",

            "automobile" => "মোটরগাড়ি", "automobiled" => "মোটরগাড়ি", "automobiling" => "মোটরগাড়ি", "motocar" => "মোটরগাড়ি",
            "auto" => "মোটরগাড়ি", "মোটরগাড়ি" => "মোটরগাড়ি", "motorgari" => "মোটরগাড়ি", "motargari" => "মোটরগাড়ি",
            "motorghari" => "মোটরগাড়ি", "matargari" => "মোটরগাড়ি", "মোটরযান" => "মোটরগাড়ি", "motorjan" => "মোটরগাড়ি",
            "matargan" => "মোটরগাড়ি", "motogan" => "মোটরগাড়ি",

            "motorcycle" => "মোটরসাইকেল", "মোটরসাইকেল" => "মোটরসাইকেল", "matarcycle" => "মোটরসাইকেল", "mototcikale" => "মোটরসাইকেল",
            "motorcikale" => "মোটরসাইকেল", "motorcikle" => "মোটরসাইকেল", "bike" => "মোটরসাইকেল", "vike" => "মোটরসাইকেল",
            "বাইক" => "মোটরসাইকেল", "ফুন্ডার" => "মোটরসাইকেল",  "fonder" => "মোটরসাইকেল", "pfonder" => "মোটরসাইকেল", "হুন্ডার" => "মোটরসাইকেল",
            "twohoilar" => "মোটরসাইকেল", "two hoilar" => "মোটরসাইকেল",

            "labor" => "শ্রম", "labour" => "শ্রম", "শ্রম" => "শ্রম", "shrom" => "শ্রম", "srom" => "শ্রম", "srm" => "শ্রম",

            "laborer" => "শ্রমকি", "laborers" => "শ্রমকি", "labourer" => "শ্রমকি", "labourers" => "শ্রমকি", "worker" => "শ্রমকি",
            "শ্রমকি" => "শ্রমকি", "কর্মী" => "শ্রমকি", "কর্মচারি" => "শ্রমকি", "কর্মচারী" => "শ্রমকি", "shromik" => "শ্রমকি", "sromik" => "শ্রমকি",
            "karmachri" => "শ্রমকি", "kormochri" => "শ্রমকি", "karmochri" => "শ্রমকি", "কামলা" => "শ্রমকি", "দিনমজুর" => "শ্রমকি",
            "দীনমজুর" => "শ্রমকি",

            "register" => "নিবন্ধন", "registration" => "নিবন্ধন", "registering" => "নিবন্ধন", "নিবন্ধন" => "নিবন্ধন",
            "nibondon" => "নিবন্ধন", "nibandon" => "নিবন্ধন", "nibandan" => "নিবন্ধন", "registri" => "নিবন্ধন",
            "nibndn" => "নিবন্ধন",

            "licence" => "লাইসেন্স", "licences" => "লাইসেন্স", "license" => "লাইসেন্স", "licenses" => "লাইসেন্স",
            "licenced" => "লাইসেন্স", "licensed" => "লাইসেন্স", "লাইসেন্স" => "লাইসেন্স", "অনুমতি পএ" => "লাইসেন্স", 
            "অনুমতিপএ" => "লাইসেন্স", "লাইসেন্সধারী" => "লাইসেন্স", "লাইসেন্সধারি" => "লাইসেন্স",

            "income" => "আয়", "incomes" => "আয়", "আয়" => "আয়", "aye" => "আয়", "iy" => "আয়", "ay" => "আয়",

            "spend" => "ব্যয়", "spends" => "ব্যয়", "expend" => "ব্যয়", "expends" => "ব্যয়", "খরচ" => "ব্যয়", "ব্যয়" => "ব্যয়",
            "ঢালা" => "ব্যয়", "baye" => "ব্যয়", "vaye" => "ব্যয়", "baie" => "ব্যয়", "vaie" => "ব্যয়", "koroch" => "ব্যয়",
            "krochs" => "ব্যয়", "kroch" => "ব্যয়",
